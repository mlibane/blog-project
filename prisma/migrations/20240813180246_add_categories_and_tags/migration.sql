...
INSERT INTO "new_Post" ("authorId", "content", "createdAt", "id", "published", "publishedAt", "title", "updatedAt") SELECT "authorId", "content", "createdAt", "id", "published", "publishedAt", "title", "updatedAt" FROM "Post";
DROP TABLE "Post";
