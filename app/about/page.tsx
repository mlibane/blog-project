  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <p className="font-satoshi mb-4">Nidix was born from a simple yet powerful idea: to create a space where thoughts and ideas could flourish in a serene digital environment. Founded in 2024, our platform will hopefully become a haven for writers, thinkers, and creatives from all walks of life.</p>
          <p className="font-satoshi">I believe that in the chaos of the digital world, there's a need for a tranquil corner where ideas can be shared, discussed, and nurtured. Nidix provides that corner, offering a minimalist, distraction-free writing experience coupled with powerful community features.</p>
        </CardContent>
      </Card>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <p className="font-satoshi">At Nidix, our mission is to empower voices, foster meaningful discussions, and create a community of lifelong learners. I strive to:</p>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <ul className="font-satoshi space-y-4">
            ...
            <li><strong>Advanced Writing Tools:</strong> From our distraction-free editor to SEO optimization features, i provide everything writers need to create impactful content.</li>
            <li><strong>Reader-Friendly Experience:</strong> I've crafted a reading experience that's easy on the eyes and rich in features like bookmarking, highlighting, and personalized recommendations.</li>
            <li><strong>Privacy-Focused:</strong> I respect the users' privacy and data, implementing strict data protection measures.</li>
          </ul>
        </CardContent>
      </Card>
